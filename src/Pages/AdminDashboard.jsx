    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      <aside className="w-64 bg-black text-white p-6 space-y-6">
        ...
        <nav className="space-y-3 text-lg">
          <button onClick={() => navigate("/AdminDashboard")} className="block hover:text-orange-400">
            Dashboard
          </button>
          <button onClick={() => navigate("/AdminTours")} className="block hover:text-orange-400">
            Manage Tours
          </button>
